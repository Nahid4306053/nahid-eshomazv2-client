  ...
  return (
    <form ref={formref} onSubmit={handelReplay} className="p-0 mt-10 w-full  comment-2">
      <div className="col-12">
        <textarea defaultValue={currentCommentId.name} style={{ height: 80 }} id="text" required name="comment" className="form-control" placeholder="Masage" cols="30" rows="2" aria-label="With textarea" ></textarea>
      </div>
