...
export default function Navbar() {
  ...
  const links = <>
    <li  > 
            <NavLink to="/" className='text-[#002347] font-bold mr-5  cursor-pointer'>Blogs</NavLink></li>
           <CategoreyDropdown/>
  ...
  <div className="drawer-content flex flex-col">
    ...
    <div className="w-full navbar py-0">
      ...
      <div className="flex-1 px-2 mx-2"><NavLink to="/" ><img className='h-14' src={webLogo} alt="" /></NavLink></div>
      <div className="flex-none hidden lg:block">
        <ul className="flex items-center ">
         {links}
          ...
          {currentUser ? <Acount/> : 
          <>
                <li>  <NavLink to="/login" className='text-[#002347] font-bold mr-3 cursor-pointer flex items-center'> Log in </NavLink></li>
                <li>  <NavLink to="/signup" className='text-[#002347] font-bold mr-3 cursor-pointer flex items-center'> Sign up</NavLink></li>
          </>  
